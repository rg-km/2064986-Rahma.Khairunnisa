...
func Migrate() (*sql.DB, error) {
	...
	_, err = db.Exec(`
			...
			VALUES 
				...
				("sekolah5", "SMA Negeri 5", 0.5, "B", 1024);`)// TODO: replace this
	...
	_, err = db.Exec(`INSERT INTO school_b_cp (registration_no, name, percentage)
	    VALUES 
		("1000", "SMA Negeri 6", 0.5),
		("2000", "SMA Negeri 7", 0.5),
		("3000", "SMA Negeri 8", 0.5),
		("4000", "SMA Negeri 9", 0.5),
		("5000", "SMA Negeri 10", 0.5);`) // TODO: replace this
	...
	_, err = db.Exec(`INSERT INTO surrogate_table_cp (registration_no, name, percentage, grade, national_rank)
		...
		("5000", "SMA Negeri 10", 0.5, "", 0) ;`) // TODO: replace this
